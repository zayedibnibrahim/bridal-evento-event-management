            ...
            <div className="row">
                ...
                <div className="col-md-10 p-5" style={{ height: '100vh' }}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {
                            errors.email && <div style={{ width: '30%' }} className="alert alert-danger mt-2" role="alert">This field is required</div>
                        }
                        {
                            success && <div style={{ width: '30%' }} className="alert alert-success mt-2" role="alert">{success}</div>
                        }
